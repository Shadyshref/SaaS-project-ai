CREATE TYPE "public"."job_info_experince_level" AS ENUM('junior', 'mid-level', 'senior');--> statement-breakpoint
CREATE TYPE "public"."questions_question_difficulty" AS ENUM('junior', 'medium', 'hard');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_info" (
	...
	"title" varchar,
	"name" varchar NOT NULL,
	"experienceLevel" "job_info_experince_level" NOT NULL,
